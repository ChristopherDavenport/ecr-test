...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/ChristopherDavenport/ecr-test"),
        "git@github.com:ChristopherDavenport/ecr-test.git"
      )
    ),
    homepage := Some(url("https://github.com/ChristopherDavenport/ecr-test")),
